...
class Register extends React.Component {
            ...
            axios.get('http://localhost:3000/userDetails/?q='+this.state.username).then((res)=>{
                ...
                if(res.data[0]){
                   ...
                   this.initialsate()
                    ...
                    axios.get('http://localhost:3000/userDetails/?q='+this.state.email).then((res)=>{
                        console.log(res.data[0])
                        if(res.data[0]){
                           ...
                           this.initialsate();
                            ...
                            var userDetails={
                                ...
                                axios.post('http://localhost:3000/userDetails',userDetails).then((res)=>{
    ...
    checkValidation=(event)=>{
        ...
        if (event === 'confirm_password' && (this.state.confirm_password === '' || this.state.password !== this.state.confirm_password)) {
    ...
    render() { 
        return ( 
            ...
            { this.state.usernameExists &&
                  <p className="error1"><b>Username Already Exists</b></p>
            }
            {
                this.state.emailExists &&
                <p className="error1"><b>Email Aready exists</b></p>
            }
